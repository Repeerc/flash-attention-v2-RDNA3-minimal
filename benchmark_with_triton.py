...
plt.plot(n_list, flops_triton_list, label="Triton")
plt.xlabel("Seqlen")
plt.ylabel('TFlops')
plt.legend()
plt.xticks(n_list)
...
plt.plot(n_list, maxmem_triton_list, label="Triton")
plt.xlabel("Seqlen")
plt.ylabel('VRAM(MB)')
plt.legend()
plt.xticks(n_list)
...
plt.plot(d_list, flops_triton_list, label="Triton")
plt.xlabel("dim_head")
plt.ylabel('TFlops')
plt.legend()
plt.xticks(d_list)
...
plt.plot(d_list, maxmem_triton_list, label="Triton")
plt.xlabel("dim_head")
plt.ylabel('VRAM(MB)')
plt.legend()
plt.xticks(d_list)
